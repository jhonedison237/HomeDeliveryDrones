...
public class NorthState extends DirectionState {
    ...
    public void validateMovement(int positionPoint) {
        if (positionPoint + 1 > NORTH_LIMIT) {
            throw new LimitExceededException("No puedo ir más allá de 10 cuadras al norte");
        }
    }
}
